...
-define(IDLE_LIMIT_DEFAULT, 60000).
...
% These functions rely on using the process dictionary. This is usually frowned
% upon howver in this case it is done to avoid changing to a different server state
% record. Once PSE (Pluggable Storage Engine) code lands this should be moved to the
% #db{} record.
